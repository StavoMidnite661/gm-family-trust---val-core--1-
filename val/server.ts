...
async function seedDemoData() {
    ...
    const demoEntries = [
        {
            description: 'Genesis Funding - Family Trust Establishment',
            lines: [
        ...
        {
            description: 'Utility Payment Authorization - Electric Bill',
            lines: [
        ...
        {
            description: 'Housing Expense - HOA Payment',
            lines: [
...
// Seed data after a brief delay to ensure system is ready
setTimeout(() => {
