...
export const NARRATIVE_ACCOUNTS = {
  ...
  // Obligations (Observed Liabilities) - Matched to TIGERBEETLE_LEDGER_SCHEMA
  OBSERVED_AP: 2000,
  OBSERVED_ANCHOR_GROCERY_OBLIGATION: 1001,
  OBSERVED_ANCHOR_UTILITY_OBLIGATION: 1002,
  OBSERVED_ANCHOR_FUEL_OBLIGATION: 1003,
  OBSERVED_ANCHOR_MOBILE_OBLIGATION: 1004,
  OBSERVED_ANCHOR_HOUSING_OBLIGATION: 1005,
  OBSERVED_ANCHOR_MEDICAL_OBLIGATION: 1006,
